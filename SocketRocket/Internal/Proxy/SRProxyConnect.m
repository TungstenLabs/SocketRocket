...
-(instancetype)initWithURL:(NSURL *)url socksHost:(NSString *)socksHost socksPort:(NSUInteger)socksPort
{
    self = [super init];
    if (!self) return self;
...
- (void)_initializeStreams
{
    ...
    if (_socksHost && _socksPort != NSNotFound) {
