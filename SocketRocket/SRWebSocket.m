...
- (instancetype)initWithURLRequest:(NSURLRequest *)request protocols:(NSArray<NSString *> *)protocols securityPolicy:(SRSecurityPolicy *)securityPolicy socksHost:(NSString *)socksHost socksPort:(NSUInteger)socksPort
{
    self = [super init];
    if (!self) return self;
...
#pragma clang diagnostic pop
    ...
    return [self initWithURLRequest:request protocols:protocols securityPolicy:securityPolicy socksHost:nil socksPort:NSNotFound];
}

- (instancetype)initWithURLRequest:(NSURLRequest *)request securityPolicy:(SRSecurityPolicy *)securityPolicy
{
    return [self initWithURLRequest:request protocols:nil securityPolicy:securityPolicy socksHost:nil socksPort:NSNotFound];
}
...
- (void)open
{
    ...
    _proxyConnect = [[SRProxyConnect alloc] initWithURL:_url socksHost:_socksHost socksPort:_socksPort];
